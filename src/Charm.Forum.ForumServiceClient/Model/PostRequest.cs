...
namespace Charm.Forum.ForumServiceClient.Model
{
    ...
    /// PostRequest
    /// </summary>
    [DataContract(Name = "PostRequest")]
    public partial class PostRequest : IEquatable<PostRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines PostType
        /// </summary>
        ...
        public PostRequest(string title = default(string), string text = default(string), string username = default(string), PostTypeEnum postType = default(PostTypeEnum))
        {
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for PostRequest and cannot be null");
            // to ensure "text" is required (not null)
            this.Text = text ?? throw new ArgumentNullException("text is a required property for PostRequest and cannot be null");
            // to ensure "username" is required (not null)
            this.Username = username ?? throw new ArgumentNullException("username is a required property for PostRequest and cannot be null");
        ...
        {
            return this.Equals(input as PostRequest);
        }

        /// <summary>
        /// Returns true if PostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostRequest input)
        {
            if (input == null)
                return false;
